...
export default {
  ...
  theme: {
    extend: {
      colors: {
        // Professional Blue (Primary) - Trust & Technology
        primary: {
          50: '#eff6ff',
          100: '#dbeafe',
          200: '#bfdbfe',
        ...
        // Vibrant Orange (Accent) - Energy & Employment
        accent: {
          50: '#fff7ed',
          100: '#ffedd5',
          200: '#fed7aa',
      ...
      backgroundImage: {
        ...
        'trust-gradient': 'linear-gradient(135deg, #3b82f6 0%, #f97316 100%)',
        'skilltrust-gradient': 'linear-gradient(135deg, #10b981 0%, #3b82f6 100%)',
      },
      boxShadow: {
      ...
      keyframes: {
        ...
        'pulse-glow': {
          '0%, 100%': { opacity: '1', boxShadow: '0 0 40px rgba(59, 130, 246, 0.3)' },
          '50%': { opacity: '0.8', boxShadow: '0 0 60px rgba(59, 130, 246, 0.5)' },
        },
        'shimmer': {
