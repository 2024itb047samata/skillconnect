...
import { Star, MapPin, Clock, CheckCircle, Calendar, MessageSquare, Shield, Briefcase, ChevronLeft, Send, X, Wrench, Zap, Paintbrush, Building2, Hammer, Car, Sparkles, Wind, DollarSign } from 'lucide-react';
              ...
              >
                {worker.profile.avatar_url ? (
                  <img
                    ...
                    alt=""
                    className="w-32 h-32 rounded-full object-cover ring-4 ring-white/20 shadow-glow"
                  />
                ) : (
                    ...
                    <div key={r.id} className="border-b border-surface-800 pb-4 last:border-0 last:pb-0">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <div className="flex items-center gap-0.5">
                          {[1, 2, 3, 4, 5].map((s) => (
                            <Star key={s} className={`w-3 h-3 ${s <= r.rating ? 'text-amber-400 fill-amber-400' : 'text-surface-700'}`} />
                          ))}
                        </div>
                      </div>
        ...
        {showBookModal && (
          ...
          >
            ...
            >
              ...
              <motion.button
                onClick={handleBook}
                className="w-full mt-6 py-4 premium-button"
