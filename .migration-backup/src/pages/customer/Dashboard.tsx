...
import { Search, Star, MapPin, Clock, Briefcase, Calendar, MessageSquare, Wrench, Zap, Paintbrush, Building2, Hammer, Car, Sparkles, Wind, CheckCircle, ArrowRight, TrendingUp } from 'lucide-react';
        ...
        >
          {quickActions.map((action, i) => (
            <motion.div key={i} variants={itemVariants}>
              <Link
                to={action.href}
                className="glass-card group p-5 flex items-center gap-4 card-hover"
              >
        ...
        >
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-white">Featured Workers</h2>
            </div>
                  ...
                  <motion.div key={worker.id} variants={itemVariants}>
                    ...
                    >
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="font-semibold text-white group-hover:text-primary-400 transition-colors">{worker.profile?.full_name}</h3>
