      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                  ...
                  >
                    ...
                    <div className="mt-4 flex flex-wrap gap-2">
                      {worker.skills.slice(0, 3).map((s) => (
                        <span key={s} className="px-3 py-1 bg-primary-100 dark:bg-primary-500/20 text-primary-700 dark:text-primary-300 border border-primary-200 dark:border-primary-500/30 rounded-full text-sm font-medium">{s}</span>
                      ))}
                    </div>
                    <div className="mt-4 pt-4 border-t border-gray-200 dark:border-surface-800 flex items-center justify-between">
                      ...
                      {worker.hourly_rate && (
                        <span className="text-sm font-medium text-transparent bg-clip-text bg-gradient-to-r from-primary-500 to-accent-500">${worker.hourly_rate}/hr</span>
                      )}
                    </div>
                  </Link>
                </motion.div>
        ...
        {!loading && filtered.length === 0 && (
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 dark:text-gray-400 text-lg">No workers found matching your criteria</p>
          </div>
        )}
      </div>
    </div>
